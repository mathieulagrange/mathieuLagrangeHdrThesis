...
Le problème du regroupement peut se formaliser comme un . Soit un ensemble d'objets $o_n$, un nombre de classes $C$ et une notion de dissimilarité entre objets $d(o_i, o_j)$, le propos de ces algorithmes est de trouver une partition de cet ensemble en $K$ classe qui minimise la dissimilarité intra classe moyenne aux classes. On notera
...
On peut problème de partitionnement de graphe
