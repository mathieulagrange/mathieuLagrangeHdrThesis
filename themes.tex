...
Un \og résonateur de Helmholtz \fg, implantation physique d'un filtre passe bande.
\end{center}}.
...
\begin{equation}
  ...
  Nous avons considéré un modèle de scènes sonores qui permet d'aisément générer des scènes sonores tout en contrôlant ces paramètres\marginnote{Une implantation de ce modèle dédiée à l'évaluation a été réalisée en Matlab \url{https://bitbucket.org/mlagrange/simscene}. Un outil alternatif a été développé en Python par Justin Salamon \url{https://github.com/justinsalamon/scaper}.}. Le modèle proposé se présente comme suit. Pour une scène $s$ composée de $z$ classes de sons, on a :
