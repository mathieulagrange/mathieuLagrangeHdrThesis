...
La méthode couramment prise est donc d'estimer cette applicabilité
...
La revue par les pairs\marginnote{Dans une forme moderne incluant la notion de recherche reproductible comme celle dévelopée dans le Chapitre \ref{}} constitue probablement la seule approche  à l'heure actuelle.
