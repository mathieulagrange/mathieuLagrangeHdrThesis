...
\marginnote[4cm]{Question : "Maître, comment savoir si quelque chose est vrai ou faux ? \\
...
A des fins de reproducibilité, on supposera que $d$ est pérenne, \textit{i.e.} n'est pas modifié par $p$. $s$ et $o$ sont non volatils, \textit{i.e.} stockés sur disque. $p$ peut éventuellement être scinder en plusieurs étapes de traitement, qui appliquées de manière séquentielle, permettent de produire le même résultat ($s_2=s$ et $o_2=o$). \marginnote[-1cm]{\input{exp/expStep2} \vspace{-.4cm} Séparation de ce processus en deux étapes.}
