\chapter{La méthode scientifique en sciences des données} \label{sec:methode}
...
\marginnote{A titre critique, Bob Sturm poursuit depuis plusieurs années un travail \og d'auscultation \fg  des travaux effectués en mir et organise un séminaire intitulé "Horse" en référence à Clever Hans (edition 2014 \url{} et 2018 \url{}).}
...
\section{Méthodologie expérimentale en sciences des données} \label{sec:xp}
