...
\begin{tikzpicture}[scale=0.8, label distance=1.5mm]
  ...
  \coordinate[label=above:Expressivité] (C) at (2,3.464);
  \draw [line width=1.5pt] (A) -- (B) -- (C) -- cycle;
  \draw [blue, fill=blue, line width=1.5pt] (1.6,2.2) circle [radius=.1 cm];
  \end{tikzpicture}
...
triangle avec des couleurs

approche modale, temporelle, causale, linéaire

causal non linéarité
