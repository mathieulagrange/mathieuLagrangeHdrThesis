...
La plateforme expLanes permet grace a ces moduales de proposer des interfaces normalisée pour toutes les étapes de l'expérimentation

\begin{enumerate}
  \item conception : création ou modification des étapes de traitement
  \item planification : définition des facteurs
  \item implantation : implentation de $p$ dans les fichiers dédiés aux étapes de traitement
  \item configuration :
  \item exposition : choix des conditions expérimentales d'intérêt et définition du mode d'exposition utilisé
\end{enumerate}
